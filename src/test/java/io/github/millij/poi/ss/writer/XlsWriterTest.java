...
public class XlsWriterTest {
    ...
    @Test
    public void test_write_xls_from_map() throws IOException {
        final String filepath_output_file = _path_test_output.concat("single_sheet_map_data.xls");

        // Excel Writer
        LOGGER.info("#test_write_xls_from_map :: Writing to file - {}", filepath_output_file);
        final SpreadsheetWriter gew = new XlsWriter();
    ...
    @Test
    public void test_write_xls_from_map_default_sheetname() throws IOException {
        final String filepath_output_file = _path_test_output.concat("single_sheet_map_data_default_sheetname.xls");

        // Excel Writer
        LOGGER.info("#test_write_xls_from_map_default_sheetname :: Writing to file - {}", filepath_output_file);
        final SpreadsheetWriter gew = new XlsWriter();
